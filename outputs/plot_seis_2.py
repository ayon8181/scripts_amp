...
def plot(event,station,time,shift,loc,rat):
    ...
    if rat>=0:
       ...
       plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/S/red/"+event+"_"+station+".png")
    else:
        map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='blue')
        plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/S/blue/"+event+"_"+station+".png")
    plt.close(fig)
...
def plot(event,station,time,shift,loc,rat):
    try:
        ...
        if rat>=0:
           map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='red')
           plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/SS/red/"+event+"_"+station+".png")
        else:
            map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='blue')
            plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/SS/blue/"+event+"_"+station+".png")
        plt.close(fig)
    except ValueError:
           return 0
...
def plot(event,station,time,shift,loc,rat):
    try:
        ...
        if rat>=0:
           map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='red')
           plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/SSS/red/"+event+"_"+station+".png")
        else:
            map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='blue')
            plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/SSS/blue/"+event+"_"+station+".png")
        plt.close(fig)
    except ValueError:
           return 0
...
def plot(event,station,time,shift,loc,rat):
    try:
        ...
        if rat>=0:
           map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='red')
           plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/ScS/red/"+event+"_"+station+".png")
        else:
            map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='blue')
            plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/ScS/blue/"+event+"_"+station+".png")
        plt.close(fig)
    except ValueError:
           return 0
...
def plot(event,station,time,shift,loc,rat):
    try:
        ...
        if rat>=0:
           map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='red')
           plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/Sdiff/red/"+event+"_"+station+".png")
        else:
            map.drawgreatcircle(elon,elat,slon,slat,ls='None',marker='o',markersize=2,color='blue')
            plt.savefig("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/Sdiff/blue/"+event+"_"+station+".png")
        plt.close(fig)
    except ValueError:
           return 0
