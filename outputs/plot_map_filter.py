...
df_plot = df_plot[(df_plot["7"]>=90) & (df_plot["7"]<=120)]
...
for i,df in enumerate(file_names):
    ...
    if i==0:
        fig.colorbar()
    fig.savefig(plot_dir+"/global_amp_"+file_names[i]+"_"+ph+"_low.png",dpi=600)
    plt.close()
    ...
    if i==0:
        fig.colorbar()
    fig.savefig(plot_dir+"/global_env_"+file_names[i]+"_"+ph+"_low.png")
    plt.close()
    ...
    if i==0:
        fig.colorbar()
    fig.savefig(plot_dir+"/global_3d1d_"+file_names[i]+"_"+ph+"_low.png")
    plt.close()
    ...
    if i==0:
        fig.colorbar()
    fig.savefig(plot_dir+"/global_cc_t_"+file_names[i]+"_"+ph+"_low.png")
    plt.close()
    ...
    if i==0:
        fig.colorbar()
    fig.savefig(plot_dir+"/global_amp_misfit_"+file_names[i]+"_"+ph+"_low.png")
    plt.close()
...
plt.ylabel("Counts")
plt.tight_layout()
plt.savefig(plot_dir+"/Histogram_stations_"+ph+"_low.png",dpi=600)
plt.close()
...
plt.ylabel("Counts")
plt.tight_layout()
plt.savefig(plot_dir+"/Histogram_events_"+ph+"_low.png",dpi=600)
plt.close()
