...
for i,f in enumerate(file_names):
    temp    = pd.read_csv("/scratch1/09038/ayon8181/pypaw_workflow_test/outputs/"+f,header=None,delimiter=" ",skipinitialspace=True)
    df.append(temp)
...
d_all=pd.merge(d_all,df[5],on=[0,1,2,3,4,5,6,7],suffixes=("_glad","_prem_atten"))
